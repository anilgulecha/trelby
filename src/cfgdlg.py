...
class MiscPanel(wx.Panel):
    def __init__(self, parent, id, cfg):
        ...
        self.addSpin("confDel", "Confirm deletes >= this many lines\n"
                    " (0 = disable):", self, vsizer, "confirmLineDeletes")
    ...
    def OnMisc(self, event = None):
        ...
        self.cfg.confirmLineDeletes = util.getSpinValue(self.confDelEntry)
    ...
    def cfg2gui(self):
        ...
        self.confDelEntry.SetValue(self.cfg.confirmLineDeletes)
