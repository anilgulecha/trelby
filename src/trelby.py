...
class GlobalData:
    def __init__(self):
        ...
        v.addInt("navWidth", 280, "NavWidth", 100, 9999)
...
class MyPanel(wx.Panel):
    ...
    def __init__(self, parent, id):
        ...
        self.nav = scenenav.MyNavigator(self, -1, gd.navWidth, getCfgGui, self.NavResize)
    ...
    def NavResize(self, w):
        self.nav.SetMinSize(wx.Size(w, -1))
        gd.navWidth = w
        self.hsizer.Layout()
